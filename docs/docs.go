            ...
            "put": {
                ...
                "responses": {
                    ...
                    "409": {
                        ...
                        "description": "template.seed_conflict: an operator changed the template since the last seed; params: key, template_id, rules, published_version, last_seed_version, operator_versions (each {id, seq, author, published_at}), subject (sent now) and requested_subject (the seed's)"
                    },
                    "422": {
                        "content": {
                            "application/json": {
