        ...
        "/mail_tasks": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Derived send status: failed (at least one recipient failed), sending (none failed, some pending or processing), sent (none failed or queued, some sent), empty (no recipients)",
                        "in": "query",
                        "name": "status",
                        "schema": {
                            "enum": [
