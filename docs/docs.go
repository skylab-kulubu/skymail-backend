...
const docTemplate = `{
    ...
    "components": {
        "schemas": {
            ...
            "database.SeedConflictRule": {
                "enum": [
                    "published_by_operator",
                    "newer_operator_version",
                    "operator_subject"
                ],
                "type": "string",
                "x-enum-varnames": [
                    "SeedConflictPublishedByOperator",
                    "SeedConflictNewerOperatorVersion",
                    "SeedConflictOperatorSubject"
                ]
            },
            ...
            "handlers.MailApproval": {
                "properties": {
                    "audience": {
                        "$ref": "#/components/schemas/handlers.SendAudience"
                    },
                    "body_variables": {
                        "description": "The variables it is sent with: as submitted, or as an approver edited them.",
                        "type": "object"
                    },
                    "created_at": {
                        "type": "string"
                    ...
                    "deadline_at": {
                        "description": "Pending or returned past this, it expires.",
                        "type": "string"
                    },
                    "history": {
                        "items": {
                    ...
                    "notification": {
                        "$ref": "#/components/schemas/handlers.MailApprovalNotification"
                    },
                    "preview": {
                        "$ref": "#/components/schemas/handlers.MailApprovalPreview"
                    },
                    "preview_error": {
                        "type": "string"
                    },
                    ...
                    "submitted_at": {
                        "description": "When it was last submitted; its deadline is seven days on.",
                        "type": "string"
                    },
                    "submitter": {
            ...
            "handlers.MailApprovalChange": {
                "properties": {
                    "after": {
                        "description": "The value after; null when there is none.",
                        "type": "object"
                    },
                    "before": {
                        "description": "The value before; null when there was none.",
                        "type": "object"
                    },
                    "field": {
                    ...
                    "name": {
                        "description": "The variable's name; null for the template and the audience.",
                        "type": "string"
                    }
                },
                "type": "object"
            },
            "handlers.MailApprovalEvent": {
                "description": "What happened to it last.",
                "properties": {
                    "actor": {
                        "$ref": "#/components/schemas/handlers.MailApprovalPerson"
                    },
                    "at": {
                        "type": "string"
                    },
                    "changes": {
                        "description": "What an edit or a resubmission changed; empty for every other event.",
                        "items": {
                            "$ref": "#/components/schemas/handlers.MailApprovalChange"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    "kind": {
                        "description": "submitted, resubmitted and accepted, declined are the submitter's; edited, returned, approved, rejected an approver's; expired SkyMail's.",
                        "enum": [
                            "submitted",
                            "resubmitted",
                            "edited",
                    ...
                    "note": {
                        "description": "A rejection's reason, or the note an approver or the submitter left.",
                        "type": "string"
                    },
                    "seq": {
                        "description": "1, 2, 3… in the order they happened.",
                        "type": "integer"
                    },
                    "task_id": {
            ...
            "handlers.MailApprovalNotification": {
                "description": "On the answer to an action: the mail it sent about itself. Absent when it sent none.",
                "properties": {
                    "notified": {
                        "description": "How many people it was queued to.",
                        "type": "integer"
                    },
                    "problem": {
                        "description": "Why it reached no one or fewer than it was for: no_approvers (no one else holds skymail:mails:approve), approver_lookup_failed (Keycloak did not say in time), no_address (the submitter's token carried no e-mail), template_unavailable (the System template is not seeded), enqueue_failed. Null when it reached everyone.",
                        "enum": [
                            "no_approvers",
                    ...
                    "template_key": {
                        "description": "The System template it was sent with.",
                        "enum": [
                            "mail.approval-requested",
                            "mail.approval-resolved"
                        ],
                        "type": "string"
                    }
                },
            ...
            "handlers.MailApprovalPerson": {
                "description": "Who did it; null when SkyMail expired the request.",
                "properties": {
                    "name": {
                        "type": "string"
                    },
            ...
            "handlers.MailApprovalPreview": {
                "description": "Null when it does not render; preview_error says why.",
                "properties": {
                    "html": {
                        "type": "string"
                    },
            ...
            "handlers.MailApprovalRecipient": {
                "properties": {
                    "email": {
                        "type": "string"
                    },
            ...
            "handlers.MailApprovalSubmitter": {
                "properties": {
                    "email": {
                        "type": "string"
                    },
            ...
            "handlers.MailApprovalTemplate": {
                "properties": {
                    ...
                    "republished": {
                        "description": "The template has published another version since: approving or accepting is refused (mail_approval.template_republished) until the submitter resubmits.",
                        "type": "boolean"
                    },
                    "version_id": {
                        "type": "string"
            ...
            "handlers.SeedOverride": {
                "description": "What a forced seed wrote over: the rules that held, the version that was sent and the operator's versions after the last seed — what an unforced seed's 409 names. Left out when the seed overrode nothing, forced or not.",
                "properties": {
                    "operator_versions": {
                        "description": "The operator's versions after the last seed, oldest first, discarded drafts left out.",
                        "items": {
                    ...
                    "rules": {
                        "description": "The conflict rules that held, as template.seed_conflict names them.",
                        "items": {
                            "$ref": "#/components/schemas/database.SeedConflictRule"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "handlers.SeedRefusal": {
                "description": "The Template seed refused since the last seed that went through, because an operator changed the template (ADR-0047): a repo change waiting on a decision. Null when no seed is refused.",
                "properties": {
                    "payload_sha256": {
                        "description": "A SHA-256 of what the seed asked to write, in hex: the same content refused again has the same one.",
                        "type": "string"
                    },
                    "refused_at": {
                        "description": "When the Template seed was first refused with the content it asked for last; refused again with the same content, the time stays.",
                        "type": "string"
                    },
                    "rules": {
                        "description": "The conflict rules that held the last time: published_by_operator (the version sent is an operator's, not the last seed's), newer_operator_version (an operator wrote a version after the last seed, a draft included), operator_subject (the subject sent is an operator's).",
                        "items": {
                            "$ref": "#/components/schemas/database.SeedConflictRule"
                        },
                        "type": "array",
            ...
            "handlers.SeededTemplate": {
                "properties": {
                    ...
                    "overrode": {
                        "$ref": "#/components/schemas/handlers.SeedOverride"
                    },
                    "plain_text_content": {
                        "type": "string"
                    },
                    ...
                    "seed_refusal": {
                        "$ref": "#/components/schemas/handlers.SeedRefusal"
                    },
                    "subject": {
                        "type": "string"
                    },
            ...
            "handlers.SendSummary": {
                "properties": {
                    "daily_sent": {
                        "items": {
                            "$ref": "#/components/schemas/handlers.DailySent"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    ...
                    "send_counts": {
                        "$ref": "#/components/schemas/handlers.SendCounts"
                    },
                    "time_zone": {
            ...
            "handlers.TemplateVersion": {
                "properties": {
                    ...
                    "name": {
                        "description": "The template's name in this version; publishing it names the template so. Versions written before names were kept carry the name the template had then.",
                        "type": "string"
                    },
                    "plain_text_content": {
            ...
            "handlers.TemplateVersionSummary": {
                "description": "The version the template sent before the seed; null when it had none.",
                "properties": {
                    "author": {
                        "$ref": "#/components/schemas/database.VersionAuthor"
                    },
            ...
            "requests.ApproveMailApproval": {
                "properties": {
                    "body_variables": {
                        "additionalProperties": {},
                        "description": "The variables as the approver edited them, whole. Leave them out to send the request as it stands.",
                        "type": "object"
                    },
                    "note": {
                        "description": "A word for the submitter, mailed with the decision.",
                        "maxLength": 2000,
                        "type": "string"
                    }
                },
            ...
            "requests.DeclineMailApproval": {
                "properties": {
                    "note": {
                        "description": "A word for the record: why the edit was not taken.",
                        "maxLength": 2000,
                        "type": "string"
                    }
                },
            ...
            "requests.ReturnMailApproval": {
                "properties": {
                    "body_variables": {
                        "additionalProperties": {},
                        "description": "The variables as the approver edited them, whole. They must differ from the request's.",
                        "type": "object"
                    },
                    "note": {
                        "description": "A word for the submitter, mailed with the decision.",
            ...
            "requests.SaveTemplateDraft": {
                "properties": {
                    ...
                    "name": {
                        "description": "The template's name in this version: publishing the draft renames the template. Left out or null: kept from the version the save continues.",
                        "type": "string"
                    },
                    "plain_text_content": {
                        "description": "The Main source rendered as plain text.",
    ...
    "paths": {
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/handlers.MailApprovalItem"
                                    },
                                    "type": "array"
                                }
                            }
                        ...
                        "headers": {
                            "X-Total-Count": {
                                "description": "Number of requests matching the filter",
                                "schema": {
                                    "type": "integer"
                                }
                            }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/requests.SubmitMailApproval",
                                        "summary": "send",
                ...
                "responses": {
                    "201": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/handlers.MailApproval"
                                }
                            }
                        },
                        "description": "The request, pending, with notification"
                    },
                    "400": {
                        "content": {
                            "application/json": {
                    ...
                    "422": {
                        ...
                        "description": "mail_approval.template_unavailable, mail_approval.audience_unavailable, mail_approval.required_variables_missing (params.missing: [{name, source, reason}]) or mail_approval.unrenderable (params.error)"
                    },
                    "500": {
                        "content": {
                            "application/json": {
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        ...
                        "description": "No such request, or not the caller's to see"
                    },
                    "500": {
                        "content": {
                            "application/json": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        ...
                        "description": "mail_approval.state_conflict, mail_approval.expired, mail_approval.busy, mail_approval.template_republished, mail_approval.template_unavailable, mail_approval.audience_unavailable or mail_approval.audience_empty"
                    },
                    "500": {
                        "content": {
                            "application/json": {
            ...
            "post": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/requests.ApproveMailApproval",
                                        "summary": "approval",
                                        "description": "An edit and a note, both optional"
                                    }
                                ]
                            }
                        }
                ...
                "responses": {
                    ...
                    "403": {
                        ...
                        "description": "Not an approver, or mail_approval.own_request"
                    },
                    "404": {
                        "content": {
                            "application/json": {
                    ...
                    "409": {
                        ...
                        "description": "mail_approval.state_conflict (params.state, params.allowed), mail_approval.expired, mail_approval.busy, mail_approval.template_republished (params.submitted_version_id, params.published_version_id), mail_approval.template_unavailable, mail_approval.audience_unavailable or mail_approval.audience_empty"
                    },
                    "422": {
                        "content": {
                            "application/json": {
                        ...
                        "description": "The edit leaves a Required variable empty (mail_approval.required_variables_missing) or does not render (mail_approval.unrenderable)"
                    },
                    "500": {
                        "content": {
                            "application/json": {
            ...
            "post": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/requests.DeclineMailApproval",
                                        "summary": "decline",
                                        "description": "A note"
                                    }
                                ]
                ...
                "responses": {
                    ...
                    "409": {
                        ...
                        "description": "mail_approval.state_conflict, mail_approval.expired or mail_approval.busy"
                    },
                    "500": {
                        "content": {
                            "application/json": {
            ...
            "post": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/requests.RejectMailApproval",
                                        "summary": "rejection",
                ...
                "responses": {
                    "200": {
                        ...
                        "description": "The request, rejected, with notification"
                    },
                    "400": {
                        "content": {
                            "application/json": {
                        ...
                        "description": "validation.error: no reason, or a blank one"
                    },
                    "403": {
                        "content": {
                            "application/json": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        ...
                        "description": "mail_approval.state_conflict or mail_approval.busy"
                    },
                    "422": {
                        "content": {
                            "application/json": {
                        ...
                        "description": "mail_approval.template_unavailable, mail_approval.audience_unavailable, mail_approval.required_variables_missing or mail_approval.unrenderable"
                    },
                    "500": {
                        "content": {
                            "application/json": {
            ...
            "post": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/requests.ReturnMailApproval",
                                        "summary": "edit",
                                        "description": "The edit and a note"
                                    }
                                ]
                            }
                        }
                ...
                "responses": {
                    "200": {
                        ...
                        "description": "The request, returned, with notification"
                    },
                    "400": {
                        "content": {
                            "application/json": {
                    ...
                    "422": {
                        ...
                        "description": "mail_approval.no_edit, mail_approval.required_variables_missing or mail_approval.unrenderable"
                    },
                    "500": {
                        "content": {
                            "application/json": {
        ...
        "/mail_tasks": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Derived send status: failed (a recipient failed, or none was queued a minute after the send), sending (none failed and some pending or processing, or none queued yet within that minute), sent (none failed or queued, some sent)",
                        "in": "query",
                        "name": "status",
                        "schema": {
                            "enum": [
                ...
                "responses": {
                    "200": {
                        ...
                        "headers": {
                            "X-Total-Count": {
                                "description": "Number of sends matching the filter",
                                "schema": {
                                    "type": "integer"
                                }
                            }
        ...
        "/mail_tasks/summary": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "Days in the daily series, ending today in Europe/Istanbul (1-90)",
                        "in": "query",
                        "name": "days",
                        "schema": {
                            "default": 30,
                    ...
                    {
                        "description": "Latest sends to list, newest first (1-20)",
                        "in": "query",
                        "name": "recent",
                        "schema": {
                            "default": 5,
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/handlers.SendSummary"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/mailing_lists": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Lifecycle filter: current, inactive, all",
                        "in": "query",
                        "name": "lifecycle",
                        "schema": {
                            "default": "current",
        ...
        "/templates/by-key/{key}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Write even over an operator's change since the last seed",
                        "in": "query",
                        "name": "force",
                        "schema": {
                            "type": "boolean"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/requests.UpsertTemplateByKey",
                                        "summary": "template",
                                        "description": "Template details"
                                    }
                                ]
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/handlers.SeededTemplate"
                                }
                            }
                        },
                        "description": "The template; forced over an operator's change, also what it overrode"
                    },
                    "400": {
                        "content": {
                            "application/json": {
                        ...
                        "description": "Bad Request (validation.error, force included)"
                    },
                    "409": {
                        "content": {
                            "application/json": {
                        ...
                        "description": "template.seed_conflict: an operator changed the template since the last seed; params: key, template_id, rules, published_version, last_seed_version, operator_versions (each a version summary, as the history serves it), subject (sent now) and requested_subject (the seed's)"
                    },
                    "422": {
                        "content": {
                            "application/json": {
    ...
    "tags": [
        ...
        {
            "description": "Mail onayı: sends submitted by members without send permission, held until an approver decides them",
            "name": "Mail approval"
        }
    ],
    "servers": [
