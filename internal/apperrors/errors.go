...
var (
	ErrUnauthorized           = New("server.unauthorized", "Authentication failed.", fiber.StatusUnauthorized)
	...
	ErrServiceUnavailable     = New("server.service_unavailable", "The service is temporarily unavailable.", fiber.StatusServiceUnavailable)
